...
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title"> Tambah Biodata </h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url('biodata') ?>">Biodata</a></li>
                <li class="breadcrumb-item active" aria-current="page">Tambah Biodata</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Tambah Biodata Anggota</h4>
                    <hr class="pb-3">
                    <form action="/biodata/simpan" class="forms-sample" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="form-group <?= ($validation->hasError('nama_lengkap')) ? 'has-danger' : '' ?>">
                            <label>Nama Lengkap</label>
                            <input type="text" class="form-control" placeholder="Masukkan Nama Lengkap" name="nama_lengkap" value="<?= old('nama_lengkap') ?>">
                        ...
                        <div class="form-group <?= ($validation->hasError('nama_cantik')) ? 'has-danger' : '' ?>">
                            ...
                            <input type="text" class="form-control" placeholder="Masukkan Nama Cantik" name="nama_cantik" value="<?= old('nama_cantik') ?>">
                        ...
                        <div class="form-group <?= ($validation->hasError('angkatan')) ? 'has-danger' : '' ?>">
                            ...
                            <input type="number" class="form-control" placeholder="Angkatan Berapa" name="angkatan" min="0" value="<?= old('angkatan') ?>">
                        ...
                        <div class="form-group <?= ($validation->hasError('tgl_lahir')) ? 'has-danger' : '' ?>">
                            ...
                            <div id="datepicker-popup" class="input-group date datepicker">
                                <input type="text" class="form-control" name="tgl_lahir" placeholder="Klik untuk tanggal lahir" value="<?= old('tgl_lahir') ?>">
                        ...
                        <div class="form-group <?= ($validation->hasError('no_wa')) ? 'has-danger' : '' ?>">
                            <label>No WA</label>
                            <input type="number" class="form-control" placeholder="Masukkan No WA" name="no_wa" min="0" value="<?= old('no_wa') ?>">
                        ...
                        <div class="form-group <?= ($validation->hasError('img')) ? 'has-danger' : '' ?>">
                            ...
                            <div class="input-group col-xs-12">
                                <input type="text" class="form-control file-upload-info" name="img" disabled placeholder="Upload Image" value="<?= old('img') ?>">
